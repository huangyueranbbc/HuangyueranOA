...
<body>
	...
	<div id="MainArea">
		...
		<center>
					...
					<tr valign="bottom">
						...
						<td class="ForumPageTableTitle" align="right"
							style="padding-right: 12px;"><s:a cssClass="detail"
								...
								<img border="0" src="<%=basePath%>style/images/reply.gif" />回复</s:a>
							<a href="moveUI.html"><img border="0"
								src="<%=basePath%>style/images/edit.gif" />移动到其他版块</a> <a href="#"
							onClick="return confirm('要把本主题设为精华吗？')"><img border="0"
								src="<%=basePath%>style/images/forum_hot.gif" />精华</a> <a href="#"
							onClick="return confirm('要把本主题设为置顶吗？')"><img border="0"
								src="<%=basePath%>style/images/forum_top.gif" />置顶</a> <a href="#"
							onClick="return confirm('要把本主题设为普通吗？')"><img border="0"
								src="<%=basePath%>style/images/forum_comm.gif" />普通</a></td>
								...
								<td align="center">
									<ul class="TopicFunc">
										...
										<li class="TopicFuncLi"><a class="detail"
											href="<%=basePath%>BBS_Topic/saveUI.html"><img border="0"
												src="<%=basePath%>style/images/edit.gif" />编辑</a> <a
											class="detail" href="#" onClick="return confirm('确定要删除本帖吗？')"><img
			...
			<!--分页信息-->
			<s:form id="pageForm" action="topicAction_show?id=%{id}">
			</s:form>
				...
				<div style="padding-left: 3px;">
					<table border="0" cellspacing="1" width="98%" cellpadding="5"
						...
						<tr class="Tint" height="200">
							<td valign="top" width="50" class="Deep"><b>内容</b></td>
