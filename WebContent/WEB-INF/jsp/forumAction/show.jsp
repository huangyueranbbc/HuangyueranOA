...
<body>
		...
		<div id="Title_bar_Head">
			...
			<div id="Title">
				...
				<img border="0" width="13" height="13"
					src="<%=basePath%>style/images/title_arrow.gif" />
				【${forum.name}】中的主题列表
			</div>
	...
	<s:form id="pageForm" action="forumAction_show?id=%{id}">
		<div id="MainArea">
			<div id="PageHead"></div>
			<center>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr align="center" valign="middle">
							<td width="3" class="ForumPageTableTitleLeft"><img
								...
								src="<%=basePath%>style/images/blank.gif" /></td>
							...
							<s:iterator value="recordList">
								<tr height="35" id="d0" class="template">
									...
									<td class="ForumTopicPageDataLine" align="center"><img
										src="<%=basePath%>style/images/topicType_${type}.gif" /></td>
									<td class="Topic"><s:a cssClass="Default"
											action="topicAction_show?id=%{id}">${title}</s:a></td>
									<td class="ForumTopicPageDataLine">
										<ul class="ForumPageTopicUl">
											<li class="Author">${author.name }</li>
											<li class="CreateTime"><s:date name="postTime"
													format="yyyy年MM月dd日 HH:mm:ss" /></li>
										</ul>
									</td>
						...
						<div id="TableTail_inside">
							<table border="0" cellspacing="0" cellpadding="0" height="100%"
								...
								<tr valign=bottom>
									<td></td>
									<td>
										<%-- 使用自定义标签，以便于回显数据 --%> <s:select name="viewType"
											list="%{  #{0:'全部主题', 1:'全部精华贴'}  }" /> <s:select
