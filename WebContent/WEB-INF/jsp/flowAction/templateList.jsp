...
<link type="text/css" rel="stylesheet"
	href="<%=basePath%>style/blue/select.css" />
</head>
<body>
		...
		<div id="Title_bar_Head">
			...
			<div id="Title">
				...
				<img border="0" width="13" height="13"
					src="<%=basePath%>style/images/title_arrow.gif" /> 申请模板选择
			</div>
		...
		<tbody>
			...
			<tr>
				<td class="Detail dataContainer" datakey="formTemplateList">
					<!-- 显示表单模板列表 --> <s:iterator value="templateList">
						<div id="DetailBlock" class="template">
							<img width="16" height="16"
								src="<%=basePath%>style/images/FileType/doc.gif" />
