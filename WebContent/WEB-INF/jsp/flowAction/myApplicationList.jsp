		...
		<div id="Title_bar_Head">
			...
			<div id="Title">
				...
				<img border="0" width="13" height="13"
					src="<%=basePath%>style/images/title_arrow.gif" /> 我的申请查询
			</div>
		...
		<div style="height: 30px">
			<s:form id="pageForm" action="flowAction_myApplicationList">
				<table border=0 cellspacing=3 cellpadding=5>
					<tr>
						<td>按条件查询：</td>
						<td><s:select name="templateId" cssClass="SelectStyle"
						...
						<td><a href=""><input type="IMAGE"
								src="<%=basePath%>style/blue/images/button/query.PNG" /></a></td>
					</tr>
				</table>
			</s:form>
		</div>
			...
			<tbody id="TableData" class="dataContainer" datakey="formList">
				...
				<s:iterator value="recordList">
					<tr class="TableDetail1 template">
						<td><a href="<%=basePath%>Flow_Formflow/showForm.html">${title}</a></td>
						<td>${name}&nbsp;</td>
