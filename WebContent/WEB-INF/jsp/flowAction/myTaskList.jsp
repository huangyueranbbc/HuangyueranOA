		...
		<div id="Title_bar_Head">
			...
			<div id="Title">
				...
				<img border="0" width="13" height="13"
					src="<%=basePath%>style/images/title_arrow.gif" /> 待我审批
			</div>
				...
				<s:iterator value="taskViewList">
					<tr class="TableDetail1 template">
						...
						<td><s:date name="application.applyTime"
								format="yyyy-MMMM-dd HH:mm" />&nbsp;</td>
						<td><s:a
								action="flowAction_approveUI?taskId=%{task.id}&applicationId=%{application.id}">审批处理</s:a>
							<!-- <a href="showForm.html">查看申请信息</a> --> <s:a
								action="flowAction_approvedHistory?applicationId=%{application.id}">查看流转记录</s:a></td>
					</tr>
				</s:iterator>
	...
	<div id=PageSelectorBar>
		...
		-->
			<a href="javascript:void(0)" title="首页" style="cursor: hand;"> <img
				src="<%=basePath%>style/blue/images/pageSelector/firstPage.png" /></a>
		...
		-->
			<a href="#" title="尾页" style="cursor: hand;"><img
				src="<%=basePath%>style/blue/images/pageSelector/lastPage.png" /></a>
